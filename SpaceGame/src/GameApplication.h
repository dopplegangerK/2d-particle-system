...
private:
	...
	// Stuff for text
	static constexpr char* font_path = "../../SpaceGame/fonts/fixedsys.ttf";
	TTF_Font* super_font;
	TTF_Font* big_font;
	TTF_Font* med_font;
	...
	// music
	static constexpr char* music_path = "../../SpaceGame/sounds/level3.wav";
	Mix_Music* music = nullptr;

	//any textures
	static constexpr char* life_tex_path = "../../SpaceGame/sprites/playerLife3_blue.png";
