...
public:
	...
	//drawing stuff
	static constexpr char* sprite = "../../SpaceGame/sprites/laserRed07.png";
...
public:
	...
	//drawing stuff
	static constexpr char* sprite = "../../SpaceGame/sprites/laserGreen13.png";
	static SDL_Texture* tex;
	static int width;
	static int height;
...
public:
	...
	static constexpr char* sound_path = "../../SpaceGame/sounds/laser.wav";
